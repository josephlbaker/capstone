...
export default class PopularGames extends Component {
  ...
  componentDidMount() {
    ...
    $.ajax({
      method: 'GET',
      url: `https://www.giantbomb.com/api/games/?api_key=${key}&limit=10&format=jsonp&resources=game&filter=id:46632|36765|52647|48190|66896|37030|72014`,
      success: (res) => {
        console.log(res);
    ...
    return (
      <div className="parent">
        <Menu inverted color="blue" className="top-nav">
          <Menu.Item><h3>Trending</h3></Menu.Item>
        </Menu>
        {resultsMarkup}
      </div>
    );
